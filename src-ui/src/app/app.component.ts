        ...
        if (
          ...
          if (
            ...
            this.toastService.show({
              content: $localize`Document ${status.filename} was added to app.`,
              delay: 10000,
    ...
    this.newDocumentSubscription = this.websocketStatusService
      ...
      .subscribe((status) => {
        ...
        if (
          ...
          this.toastService.show({
            content: $localize`Document ${status.filename} is being processed by app.`,
            delay: 5000,
          })
        }
      })
    ...
    this.tourService.initialize(
      [
        ...
        },
        {
          ...
          content: $localize`Drag-and-drop documents here to start uploading or place them in the consume folder. You can also drag-and-drop documents anywhere on all other pages of the web app. Once you do, app will start training its machine learning algorithms.`,
          route: '/dashboard',
        },
        {
